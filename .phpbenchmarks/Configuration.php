...
class Configuration
{
    ...
    {
        return [
            'route' => 'https://github.com/phpbenchmarks/symfony/tree/4.4.0.1/config/routes.yaml',
            'controller' => 'https://github.com/phpbenchmarks/symfony/tree/4.4.0.1/src/Controller/HelloWorldController.php'
        ];
    }
}
